  ...
  <teleport to="#app">
    ...
    <div class="modal" v-if="base.form.modal">
      ...
      >
        ...
        <h3 class="text-md md:text-lg font-bold text-primary">NEW VISITOR</h3>
        ...
        <div class="card-body overflow-auto max-h-[60vh] p-2 lg:p-4">
          <div class="form-control">
            ...
            <input
              type="text"
              placeholder="ระบุหัวข้อหรือชื่อของ Visitor ..."
          ...
          <div class="form-control">
            ...
            <textarea
              class="textarea textarea-xs sm:textarea-sm md:textarea-md textarea-bordered border-base-content h-24"
              placeholder="ระบุรายละเอียดของ Visitor ..."
      ...
      save: async () => {
        ...
        try {
          ...
          const path = buildPath(
            null,
            "api/controllers/MYSQL/INTERNAL/HR/visitor/visitor_member"
          );
