    ...
    <div class="card shadow-lg bg-base-100">
      ...
      >
        ...
        <div :class="`${base.loading ? 'blur-sm' : ''}`">
          ...
          <div class="grid gap-3 md:grid-cols-2 grid-cols-1 items-center">
            <div class="md:text-left text-center text-sm md:mt-0 mt-1">
              Show :
              <select class="select select-bordered select-xs w-fit bg-yellow-50 text-black" 
                v-model="base.row" 
                @change="this.base_search()"
              >
...
export default {
  ...
  methods: {
    exportExcel() {
      return window.open(`${
        this.serviceUrl
      }api/controllers/MYSQL/INTERNAL/GLOBAL/exports?type=stock&total=1${
    ...
    base_search() {
      ...
      this.base.row = parseInt(this.base.row)
      this.base_get((res) => {
