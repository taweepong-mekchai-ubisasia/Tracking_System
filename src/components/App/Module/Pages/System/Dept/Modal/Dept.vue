  ...
  <teleport to="#app">
    ...
    <div class="modal" v-if="base.form.modal">
      ...
      >
        ...
        <h3 class="text-md md:text-lg font-bold text-primary">DEPARTMENT</h3>
        <div class="divider my-1"></div>
        <div class="card-body overflow-auto max-h-[60vh] p-2 lg:p-4">
          <div class="form-control">
            <label class="label">
              <span class="label-text text-xs sm:text-sm md:text-md">SAP Code.</span>
            </label>
            <input
              type="text"
              placeholder="Ref Code."
              class="input input-xs sm:input-sm md:input-md input-bordered border-base-content"
              v-model="base.form.object.ref"
            />
          </div>
          <div class="form-control">
            <label class="label">
              <span class="label-text text-xs sm:text-sm md:text-md">Department Title</span>
            </label>
            <input
              type="text"
