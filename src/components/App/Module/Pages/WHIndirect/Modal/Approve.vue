<template>
  <teleport to="#app">
    <input
      type="checkbox"
      class="modal-toggle"
      v-model="base.form.approve_modal"
    />
    <div class="modal">
      <div class="modal-box relative w-11/12 max-w-sm">
        <button
          @click="base.form.approve_modal = false"
        ...
        <div class="card-body overflow-auto max-h-[60vh]">
          ...
          <div
            ...
            v-if="
              base.dept?.length
                ? base.dept.filter((x) => x.dept == base.form.object.department).length
                  ? false
                  : true
                : true
            "
          >
            <label class="label cursor-pointer">
              ...
              <input
                ...
                v-model="base.form.object.repurchase"
              />
              ...
              <input
                ...
                name="radio-10"
                value="N"
                class="radio radio-xs checked:bg-error"
                v-model="base.form.object.repurchase"
              />
        ...
        <div class="backdrop-blur sticky top-0 items-center gap-6 flex">
          ...
          <div class="flex-1 form-control mt-6">
            <button class="btn btn-success text-white" @click="fnBase.save()">
              <Icon
  ...
  setup(props, { emit }) {
    ...
    const fnBase = {
      edit: (code, index) => {
        ...
        base.value.form.approve_modal = true;
      },
      save: async () => {
        const queryBody = {
        ...
        if (!res.success) {
          ...
          if (res.check) {
            ...
            const queryBody = {
              mailSubject: "แบบฟอร์มขออนุมัติเพื่อเบิกอุปกรณ์จากคลัง Indirect ได้รับการอนุมัติแล้ว",
              ...
              template: "email/whindirect/approve",
              row: {
          ...
          base.value.form.approve_modal = false;
