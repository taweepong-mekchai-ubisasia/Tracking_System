    ...
    >
      ...
      <ul v-if="menuArray">
        ...
        <AppModuleMenuTemplate
          ...
          :color="color[1]"
          @object_access="objectAccess"
          :access="menuArray['IndirectManagement']"
          :head="'IndirectManagement'"
        ...
        <AppModuleMenuTemplate
          ...
          :color="color[1]"
          @object_access="objectAccess"
          :access="menuArray['WarehouseIndirect']"
          :head="'WarehouseIndirect'"
