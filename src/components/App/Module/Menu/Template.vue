<template>
  ...
  <li v-if="havemenu || menutype == 'Access'">
    ...
    >
      ...
      <summary class="group text-xs">
        <span>
          <Icon :icon="icon" class="w-4 h-4" :class="`${color}`" />
        </span>
        {{ head }}
      </summary>
      <ul>
        ...
        >
          <details
            ...
            "
          >
            <summary class="group text-xs">{{ v.title }}</summary>
            <ul>
              <li
                ...
                >
                  <span class="flex-1 text-xs">
                    ...
                    <select
                      ...
                      :class="menuArray[vv.name] == 'user' ? 'bg-blue-100' : menuArray[vv.name] == 'superuser' ? 'bg-red-100' : menuArray[vv.name] == 'admin' ? 'bg-yellow-100' : menuArray[vv.name] == 'superadmin' ? 'bg-green-100' : '' "
          ...
          >
            <span class="flex-1 text-xs">
              ...
              <select
                ...
                :class="menuArray[v.name] == 'user' ? 'bg-blue-100' : menuArray[v.name] == 'superuser' ? 'bg-red-100' : menuArray[v.name] == 'admin' ? 'bg-yellow-100' : menuArray[v.name] == 'superadmin' ? 'bg-green-100' : '' "
                v-if="menutype == 'Access'"
              >
                <option selected value="none">None</option>
                <option selected value="user">User</option>
