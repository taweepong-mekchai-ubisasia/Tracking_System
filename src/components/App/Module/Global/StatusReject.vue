  ...
  <teleport to="#app">
    ...
    <div class="modal">
      <div class="modal-box relative p-0">
        ...
        <!-- <h3 class="text-lg font-bold text-error">Approve Item</h3> -->
        ...
        >
          <div class="avatar placeholder place-content-center mb-4">
            <div class="w-24 rounded-full border-4 border-error">
          ...
          <h3 class="text-lg font-bold text-error">
            Are your sure for <span class="underline underline-offset-2 decoration-double">Reject</span> this item?
          </h3>
        </div>
      ...
      try {
        const body = {
          ...
          rows: base.value.rows
            ? base.value.rows
            : [{ code: base.value.code, process: "reject" }],
        };
