    ...
    <div class="modal-box relative w-11/12 max-w-xl p-2 lg:p-4 max-h-screen">
                    ...
                    <div v-else>
                      ...
                      <button
                        ...
                        @click="
                          () => {
                            removing = false;
                            this.detail.rows.map((v) => (v['remove'] = false));
                          }
                        "
                      >
                  ...
                  <th>
                    <!-- <div class="flex items-center space-x-3">
                          <input
                            ...
                            type="checkbox"
                            :checked="v.code == base.form.unit"
                            class="checkbox checkbox-sm"
                            @click="
                              () => {
                                base.form.unit =
                                  base.form.unit == v.code ? '' : v.code;
                              }
                            "
                          />
                        </div> -->
      ...
      <div class="backdrop-blur sticky top-0 items-center gap-2 px-4 flex">
        <div class="flex-1 form-control mt-6">
          <label :for="`modal-base${component_name}`" class="btn btn-danger">Cancel</label>
        </div>
