<template>
  <div class="Login" :data-theme="theme">
    <div class="sm:hero min-h-screen sm:bg-base-200">
      <div class="sm:hero-content text-center">
        <div class="w-full sm:max-w-2xl">
          <div
            class="card flex-shrink-0 sm:w-screen w-full sm:max-w-md shadow-2xl bg-base-100 h-screen sm:h-auto flex sm:flex-row sm:flex-nowrap flex-col-reverse"
            style="align-content: center; align-items: center"
          >
            <div
              class="card-body w-[100%] h-[100vh] sm:h-auto absolute sm:relative z-10"
            >
