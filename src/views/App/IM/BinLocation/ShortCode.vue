<template>
  <AppLayout ref="AppLayoutComponent">
    <template #modal>
      <AppModulePagesWHModalShortcode
        v-model="base.data"
                    ...
                    <tbody>
                      ...
                      <th>
                        ...
                        <th class="text-right">
                          ...
                          <label
                            for="modal-remove"
                            class="btn btn-ghost text-error no-underline modal-button btn-xs"
                            @click="
                              fnRemove.item(
                                `${v.code}`,
...
import AppModulePagesWHModalShortcode from "@/components/App/Module/Pages/WH/Modal/Shortcode.vue";
