    ...
    <template #modal>
      ...
      <div class="modal">
        ...
        >
          ...
          <div
            class="card-body overflow-auto max-h-[85vh] p-1"
            v-if="base.form"
          >
      ...
      <div class="modal">
        <div class="modal-box relative text-center m-0 p-0">
          ...
          <div
            class="card-body pb-8 pt-0 max-h-[80vh] overflow-auto"
            v-if="detail.form"
          >
            ...
            <div v-if="checkbox || !detail.form.code">
                ...
                <div class="flex-1 w-auto">
                  <div class="form-control">
                    ...
                    <input
                      ...
                      type="text"
                      placeholder="Short code"
                      class="input input-sm input-bordered disabled:border-base-content input-disabled"
                      required=""
                ...
                <div class="flex-1 w-auto">
                  <div class="form-control">
                    ...
                    <input
                      ...
                      class="input input-sm input-bordered border-base-content disabled:border-base-content"
                      required=""
                ...
                <div class="flex-1 w-auto">
                  <div class="form-control">
                    ...
                    <select
                      ...
                      class="select select-sm select-bordered border-base-content w-full"
                ...
                <div class="flex-1 w-auto">
                  <div class="form-control">
                    ...
                    <input
                      type="text"
                      placeholder="Item Code"
                      class="input input-sm input-bordered disabled:border-base-content"
                      required=""
                      v-model="detail.form.item_code"
                      disabled
                    />
              ...
              <div class="grid grid-cols-2 w-full gap-4">
                <div class="flex-1 w-auto">
                  <div class="form-control">
                    ...
                    <input
                      v-if="detail.controll == 'edit' && checkbox != 'E'"
                      type="text"
                      placeholder="title"
                      class="input input-sm input-bordered disabled:border-base-content w-full"
                      required=""
                      v-model="detail.form.receive_date_dop"
                      disabled
                    />
                    <VueDatePicker 
                      v-else
                ...
                <div class="flex-1 w-auto">
                  <div class="form-control">
                    ...
                    <input
                      ...
                      class="input input-sm input-bordered disabled:border-base-content w-full"
                      required=""
                      v-model="detail.form.manufacturing_date_dop"
                      disabled
                    />
                    <VueDatePicker 
                      v-else
              ...
              <div class="grid sm:grid-cols-4 grid-cols-2 w-full gap-4">
                <div class="flex-1 w-auto">
                  <div class="form-control">
                    <label class="label">
                ...
                <div class="flex-1 w-auto">
                  <div class="form-control">
                    ...
                    <input
                      type="text"
                      placeholder="Unit"
                      class="input input-sm input-bordered disabled:border-base-content w-full input-disabled"
                      required=""
              ...
              <div class="flex w-full gap-4" v-if="detail.controll != 'create'">
                <div class="flex-1 w-auto">
                  <div class="form-control">
                    ...
                    <textarea
                      class="textarea textarea-bordered h-24 disabled:border-base-content"
              ...
              <div class="flex w-full gap-4">
                <div class="flex-1 w-auto">
                  <div class="form-control">
                    ...
                    <textarea
                      class="textarea textarea-bordered h-36 border-base-content"
  ...
  methods: {
    ...
    detail_create(rac, bay, l, p) {
      ...
      this.detail.form = {
        ...
        manufacturing_date: this.$moment(new Date()).format("YYYY-MM-DD"),
      };
    ...
    detail_edit(rac, bay, l, p, v) {
      ...
      this.detail.form.receive_date_dop = this.$moment(this.detail.form.receive_date).format('DD-MM-YYYY')
      this.detail.form.manufacturing_date_dop = this.$moment(this.detail.form.manufacturing_date).format('DD-MM-YYYY')
    ...
    detail_save() {
      ...
      if (this.checkbox == "O" || this.checkbox == "M") {
        this.detail.form.receive_date = this.$moment(this.detail.form.receive_date_dop).format('YYYY-MM-DD')
        this.detail.form.manufacturing_date = this.$moment(this.detail.form.manufacturing_date_dop).format('YYYY-MM-DD')
      } else {
        this.detail.form.receive_date = this.$moment(this.detail.form.receive_date).format('YYYY-MM-DD')
        this.detail.form.manufacturing_date = this.$moment(this.detail.form.manufacturing_date).format('YYYY-MM-DD')
      }
