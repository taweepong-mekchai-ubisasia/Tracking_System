<template>
    <AppLayout ref="AppLayoutComponent">
      <template #modal>
        <AppModulePagesSystemDeptModalDept
          v-model="base.data"
              ...
              <div>
                ...
                <div :class="`${base.pagination.loading ? 'blur-sm' : ''}`">
                  <div ref="titleZone">
                    ...
                    >
                      <h3 class="text-lg font-bold text-primary px-4">DEPARTMENT</h3>
                      <div
                    ...
                    >
                      ...
                      <tbody>
                        ...
                        >
                          <!-- <th>{{ v.id }}</th> -->
                          <td>{{ v.code }}</td>
                          <td class="font-semibold text-primary">{{ v.ref }}</td>
                            ...
                            <div class="flex items-center space-x-3">
                              <div>
                                <div class="text-xs">
                                  {{
                                    v.created_at &&
                                    $moment(v.created_at).format("YYYY") > "2000"
                            ...
                            <div class="flex items-center space-x-3">
                              <div>
                                <div class="text-xs">
                                  {{
                                    v.updated_at &&
                                    $moment(v.updated_at).format("YYYY") > "2000"
...
import AppModulePagesSystemDeptModalDept from "@/components/App/Module/Pages/System/Dept/Modal/Dept";
      ...
      get: async () => {
        ...
        try {
          ...
          const path = buildPath(
            queryParams,
            "api/controllers/MYSQL/INTERNAL/System/department"
          );
