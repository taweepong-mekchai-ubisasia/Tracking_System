<template>
  <AppLayout ref="AppLayoutComponent">
    <template #modal>
      <AppModulePagesSystemCompanyModalCompany
        v-model="base.data"
            ...
            <div>
              ...
              <div :class="`${base.pagination.loading ? 'blur-sm' : ''}`">
                <div ref="titleZone">
                  ...
                  >
                    <h3 class="text-lg font-bold text-primary px-4">COMPANY</h3>
...
import AppModulePagesSystemCompanyModalCompany from "@/components/App/Module/Pages/System/Company/Modal/Company";
      ...
      get: async () => {
        ...
        try {
          ...
          const path = buildPath(
            queryParams,
            "api/controllers/MYSQL/INTERNAL/System/company"
          );
