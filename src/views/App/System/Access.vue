<template>
  <AppLayout ref="AppLayoutComponent">
    <template #modal>
      <AppModulePagesSystemAccessModalAccess
        v-model="base.data"
            ...
            <div>
              ...
              <div :class="`${base.pagination.loading ? 'blur-sm' : ''}`">
                <div ref="titleZone">
                  ...
                  >
                    <h3 class="text-lg font-bold text-primary px-4">ACCESS</h3>
...
import AppModulePagesSystemAccessModalAccess from "@/components/App/Module/Pages/System/Access/Modal/Access";
