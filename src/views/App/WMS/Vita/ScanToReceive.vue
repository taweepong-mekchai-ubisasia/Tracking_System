    ...
    <template #view>
      <div class="flex" style="justify-content: center; flex-wrap: wrap;">
        <div :class="base.form ? 'grid grid-cols-1 md:grid-cols-2 w-full h-full bg-white rounded-lg shadow-xl' : 'w-[calc(100vh-385px)] h-full bg-white rounded-lg shadow-xl'">
          <div :class="base.form ? 'base-300 flex items-center justify-center' : 'flex items-center justify-center'">
            <div class="join join-vertical w-full">
              <div class="collapse collapse-arrow join-item border border-base-300">
                ...
                <div :class="choose ? 'collapse-content h-[calc(100vh-282px)]' : 'collapse-content h-full'" style="display: flex; flex-direction: column; align-items: center;"> 
                  ...
                  <qrcode-stream
                    ...
                    v-if="select"
                  ></qrcode-stream>
                  <span class="text-xs text-blue-500 mt-1">{{ connection ? 'Connected' : 'Not Connected' }}</span>
                </div>
              </div>
              <div class="collapse collapse-arrow join-item border border-base-300">
                  <input type="radio" name="my-accordion-4" :checked="!choose" @click="choose = !choose" /> 
          ...
          <div class="grid grid-rows-2 gap-1 bg-gray rounded-r-lg shadow-xl p-3 w-full" v-if="base.form">
            ...
            <div class="rounded-lg border-dotted border-2 border-primary p-2 overflow-x-auto w-full" :class="h > 800 ? 'h-96' : 'h-72'" v-if="log.form">
              ...
              <div class="mt-3 h-3/4 overflow-x-auto">
