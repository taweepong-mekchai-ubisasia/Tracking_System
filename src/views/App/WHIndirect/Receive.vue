                        ...
                        >
                          ...
                          <th v-else class="text-right">
                            <label
                              ...
                              "
                              v-if="user.access.WHIndirect.WHIndirectReceive == 'superadmin'"
                            >
                              ลบ
                            </label>
        ...
        <div class="modal-box relative w-11/12 max-w-md">
          ...
          <div class="card-body overflow-auto" style="max-height: 60vh;">
            <div class="grid grid-cols-2 gap-3">
              ...
              <div class="form-control">
                <label class="label">
                  <span class="label-text">ราคา</span><span class="text-xs text-error">{{ msg.price }}</span>
                </label>
                <input
                  type="number"
                  placeholder="Price"
        ...
        <div class="card">
          <div role="tablist" class="tabs tabs-lifted">
            <input
              ...
              name="WHI"
              aria-label="IM"
              @change="setCheckbox('im')"
              :checked="by.tab == 'im' ? true : false"
              :class="'font-semibold'"
            />
            <div
              role="tabpanel"
            ...
            >
              ...
              <!-- <div class="border-2 border-dashed rounded-xl p-3"> -->
                ...
                <div class="overflow-x-auto w-full max-h-[60vh] my-3 shadow rounded-xl">
                  ...
                  <table class="table table-xs table-pin-rows table-pin-cols table-zebra" v-else>
                    <thead>
                      <tr class="italic">
                        ...
                        <th v-if="user.access.WHIndirect.WHIndirectReceive != 'user'"></th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      <!-- :class="(parseInt(v.min) >= parseInt(v.amount)) ? 'bg-red-200' : ''" -->
                        ...
                        <th class="text-right" v-if="user.access.WHIndirect.WHIndirectReceive != 'user'">
                          <label
                            for="modal-base"
            ...
            <input
              ...
              name="WHI"
              aria-label="PD"
              @change="setCheckbox('pd')"
              :checked="by.tab == 'pd' ? true : false"
              :class="'font-semibold'"
            />
            <div
              role="tabpanel"
            ...
            <input
              ...
              name="WHI"
              aria-label="QA"
              @change="setCheckbox('qa')"
              :checked="by.tab == 'qa' ? true : false"
              :class="'font-semibold'"
            />
            <div
              role="tabpanel"
            ...
            <input
              ...
              name="WHI"
              aria-label="QC"
              @change="setCheckbox('qc')"
              :checked="by.tab == 'qc' ? true : false"
              :class="'font-semibold'"
            />
            <div
              role="tabpanel"
            ...
            <input
              ...
              name="WHI"
              aria-label="RD"
              @change="setCheckbox('rd')"
              :checked="by.tab == 'rd' ? true : false"
              :class="'font-semibold'"
            />
            <div
              role="tabpanel"
  ...
  methods: {
    ...
    base_get(callback) {
      new Query('base','get').get(this, `${
          this.serviceUrl
        }api/controllers/MYSQL/INTERNAL/WHI/item?total=1&owner=${this.by.tab}&page=${
          this.base.page
    ...
    // },
    detail_save(type) {
      if(!this.detail.form.qty || !this.detail.form.price) {
        if(!this.detail.form.qty) this.msg.qty = '*กรอกข้อมูล*'
        else this.msg.qty = ''
        if(!this.detail.form.price) this.msg.price = '*กรอกข้อมูล*'
        else this.msg.price = ''
        return;
      } else {
        this.msg.qty = ''
