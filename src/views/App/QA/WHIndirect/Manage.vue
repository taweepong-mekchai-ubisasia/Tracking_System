                  ...
                  <div class="form-control">
                    ...
                    <div class="join w-full">
                      ...
                      <AppModuleGlobalSelectSearch
                        ...
                        :delay="0.5"
                        :limit="10"
                        :customClass="`join-item join w-full input input-bordered ${
                        ...
                        "
                        :url="`${serviceUrl}controllers/MYSQL/INTERNAL/QA/Indirect/item`"
                  ...
                  <template v-if="vers2Active && base.form.status">
                    ...
                    <div class="form-control">
                      ...
                      <AppModuleGlobalSelectSearch
                        ...
                        "
                        :url="`${serviceUrl}controllers/MYSQL/INTERNAL/QA/Indirect/request`"
                        :param="`&total=1`"
                      />
                    </div>
                ...
                >
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td>
                        <span class="pr-2">{{ row.status }}</span>
                      </td>
                      <!-- <td>
                        <span class="pr-2">{{ row. }}</span>
                      </td> -->
                      <td>{{ row.doc }}</td>
                      <td>
                        <div class="flex items-center space-x-3">
                          <div>
                            ...
                            <div class="text-xs">{{ row.item }}</div>
                          </div>
                        </div>
                      </td>
                      <td>{{ row.qty }}</td>
                      ...
                      <td>
                        <div class="flex items-center space-x-3">
                          <div>
                            <div class="text-xs">
                              {{ row.requestTitle ? row.requestTitle : "-" }}
                            </div>
                            <div class="text-xs">
                              {{ row.doc ? row.doc : "-" }}
                            </div>
  ...
  methods: {
    ...
    base_get(callback) {
      fetch(
        `${
          this.serviceUrl
        }controllers/MYSQL/INTERNAL/QA/Indirect/transaction?total=1&page=${
          this.base.page
        }${this.base.row ? `&rows=${this.base.row}` : ""}${
          this.base.q ? `&q=${this.base.q}` : ""
        }`,
    ...
    base_save() {
      ...
      fetch(
        `${this.serviceUrl}controllers/MYSQL/INTERNAL/QA/Indirect/transaction`,
        {
    ...
    req_item_get(callback) {
      fetch(
        `${this.serviceUrl}controllers/MYSQL/INTERNAL/QA/Indirect/request_item?total=1&doc=${this.base.form.doc}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
