            ...
            <div>
              ...
              <div :class="`${base.pagination.loading ? 'blur-sm' : ''}`">
                <div ref="titleZone">
                  ...
                  >
                    <h3 class="text-lg font-bold text-primary w-full text-left">RETAIN&nbsp;REQUEST</h3>
                  ...
                  >
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td class="font-bold italic">{{ v.status.toUpperCase() }}</td>
                        ...
                        <th class="text-right">
                          <label
                            class="btn btn-link text-gray-500 font-bold no-underline modal-button btn-xs"
                            @click="
                              $refs.baseModal.fnBase.edit(`${v.code}`, `${i}`)
                            "
                          >
                            <Icon 
                              icon="tdesign:folder-details"
                              class="w-4 h-4 block lg:hidden"
                            />
                            <span class="hidden lg:block">Detail</span>
                          </label>
                        </th>
                      </tr>
                    </tbody>
    ...
    const fnBase = {
      ...
      get: async () => {
        ...
        try {
          ...
          // if (user.value.access.QA.QAWHRetainRequestUBP == 'user') queryParams['user'] = user.value.code;
          // if (user.value.access.QA.QAWHRetainRequestUBP == 'superuser') {
          //   if (user.value.department == '1705649840b0cd6') {
          //     queryParams['rdAdmin'] = true;
          //   } else {
          //     queryParams['dept'] = user.value.department;
          //   }
          // } 
          ...
          if (res.success) {
            ...
            base.value.data.approver = res.approver;
            base.value.data.wh = 'ubp';
