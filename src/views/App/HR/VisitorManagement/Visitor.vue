<template>
  <AppLayout ref="AppLayoutComponent">
    <template #modal>
      <AppModulePagesHRVisitorModalVisitor
        v-model="base.data"
            ...
            <div>
              ...
              <div :class="`${base.pagination.loading ? 'blur-sm' : ''}`">
                <div ref="titleZone">
                  ...
                  >
                    <h3 class="text-lg font-bold text-primary px-2 sm:px-4">MASTER&nbsp;VISITOR&nbsp;LISTS</h3>
                    <div
...
import AppModulePagesHRVisitorModalVisitor from "@/components/App/Module/Pages/HR/Visitor/Modal/Visitor";
