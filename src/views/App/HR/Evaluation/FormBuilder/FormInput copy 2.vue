<template>
        ...
        >
          ...
          >
            <label class="label cursor-pointer">
              <span class="label-text">{{ option }}</span><br />
              <input type="checkbox" class="checkbox checkbox-xs sm:checkbox-sm md:checkbox-md checkbox-primary" />
            </label>
          </div>
        </div>
        <label
  ...
  <summary class="btn btn-link m-1"><Icon icon="lucide:more-vertical" class="w-4 h-4"/></summary>
