                        ...
                        <label
                          ...
                          @click="
                            remove_item(
                              `${v.code}`,
                              'base',
                              'controllers/MYSQL/INTERNAL/Event/Coupon/coupon'
                            )
                          "
                          >remove
                        </label>
  ...
  methods: {
    ...
    base_get(callback) {
      new Query('base','get').get(this, `${
          this.serviceUrl
        }api/controllers/MYSQL/INTERNAL/Event/Coupon/coupon?total=1&page=${
          this.base.page
    ...
    base_save() {
      ...
      new Query('base', this.base.controll == "create" ? "POST" : "PUT").set(this, `${this.serviceUrl}api/controllers/MYSQL/INTERNAL/Event/Coupon/coupon`, obj, (res) => {
        if (!res.success) {
        // localStorage.removeItem("user_token");
        // this.$router.push({ name: `Login` });
        } else {
    ...
    detail_save(type) {
      if (!this.base.current) {
        ...
        new Query('detail', this.detail.controll == "create" ? "POST" : "PUT").set(this, `${this.serviceUrl}api/controllers/MYSQL/INTERNAL/Event/Coupon/coupon`, obj, (res) => {
          if (!res.success) {
            // localStorage.removeItem("user_token");
            // this.$router.push({ name: `Login` });
          } else {
