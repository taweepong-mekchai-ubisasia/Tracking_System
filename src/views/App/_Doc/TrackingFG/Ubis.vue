                ...
                <div ref="titleZone">
                  ...
                  >
                    <button 
                      ...
                      @click="file = 'คู่มือการใช้งาน_Tracking_FG_Ubis_V_2'" 
                      :disabled="file == 'คู่มือการใช้งาน_Tracking_FG_Ubis_V_2'"
                    >
                      คู่มือการใช้งาน Tracking FG Ubis V.2 (ปัจจุบัน)
                    </button>
                    <button 
                      class="btn btn-xs disabled:bg-primary disabled:text-white" 
                      @click="file = 'คู่มือการใช้งาน_Tracking_FG_Ubis_V_1'" 
                      :disabled="file == 'คู่มือการใช้งาน_Tracking_FG_Ubis_V_1'"
                    >
                      คู่มือการใช้งาน Tracking FG Ubis V.1 (เก่า)
                    </button>
                    <button 
                      class="btn btn-xs disabled:bg-primary disabled:text-white" 
  ...
  setup() {
    ...
    const download = (source, filename) => {
      ...
      document.body.removeChild(link);
		...
		// const exportDiagram = (file) => {
    //   return window.open(
    //     `${serviceUrl.value}upload/_Doc/TrackingFG/${file}.drawio`
    //   );
    // };
