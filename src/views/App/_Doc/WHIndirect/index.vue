                ...
                <div ref="titleZone">
                  ...
                  >
                    ...
                    <button 
                      ...
                      @click="exportExcel('WH_Indirect-Item_master-IM')" 
                    >
                    ...
                    <button 
                      class="btn btn-xs btn-neutral" 
                      @click="exportExcel('WH_Indirect-Item_master-PRD-UBP')" 
                    >
                      <Icon icon="file-icons:microsoft-excel" />
                      Master PRD Compound
                    </button>
                    <button 
                      class="btn btn-xs btn-neutral" 
                      @click="exportExcel('WH_Indirect-Item_master-PRD-UBA')" 
                    >
                      <Icon icon="file-icons:microsoft-excel" />
                      Master PRD Lacquer
                    </button>
                    <button 
                      class="btn btn-xs btn-neutral" 
                      @click="exportExcel('WH_Indirect-Item_master-QA')" 
                    >
                      <Icon icon="file-icons:microsoft-excel" />
                      Master QA
                    </button>
                    <button 
                      class="btn btn-xs btn-neutral" 
                      @click="exportExcel('WH_Indirect-Item_master-QC')" 
                    >
                      <Icon icon="file-icons:microsoft-excel" />
                      Master QC
                    </button>
                    <button 
                      class="btn btn-xs btn-neutral" 
                      @click="exportExcel('WH_Indirect-Item_master-RD')" 
                    >
                      <Icon icon="file-icons:microsoft-excel" />
                      Master RD
                    </button>
...
export default {
  ...
  setup() {
    ...
    const download = (source, filename) => {
      ...
      link.href = `${serviceUrl.value}/upload/_Doc/WHIndirect/${file.value}.pdf`;
      link.target = '_blank';
    ...
    const exportExcel = (file) => {
      return window.open(
        `${serviceUrl.value}upload/_Doc/WHIndirect/${file}.xlsx`
      );
    };
