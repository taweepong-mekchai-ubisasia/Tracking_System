              ...
              <div :class="`${base.pagination.loading ? 'blur-sm' : ''}`">
                <div ref="titleZone">
                  ...
                  >
                    <button
                      ...
                      @click="
                        file = 'คู่มือการใช้งาน_Automate_Ticket_TRR'
                      "
                      :disabled="
                        file == 'คู่มือการใช้งาน_Automate_Ticket_TRR'
                      "
                    >
											คู่มือการใช้งาน Automate Ticket TRR
                    </button>
                  </div>
                ...
                >
                  <div style="height: 74vh" v-if="file">
                    <PDFViewer
                      :source="`${serviceUrl}/api/controllers/MYSQL/INTERNAL/Global/doc?file=${file}.pdf&path=TicketTRR`"
...
export default {
  ...
  setup() {
    ...
    const download = (source, filename) => {
      ...
      link.href = `${serviceUrl.value}/upload/_Doc/TicketTRR/${file.value}.pdf`;
      link.target = "_blank";
    ...
    // const exportExcel = () => {
    //   return window.open(
    //     `${serviceUrl.value}upload/_Doc/TicketTRR/ฟอร์มเก็บสัญญา_Rev5.xlsx`
    //   );
    // };
