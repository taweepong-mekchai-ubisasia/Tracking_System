          ...
          <div class="card shadow-lg bg-base-100">
            <div class="card-body overflow-auto">
              <div class="border-dashed border-2 rounded-lg p-2">
                ...
                <div class="grid gap-3 lg:grid-cols-3 grid-cols-1 mt-3">
                  <div class="join">
                    <button
                    ...
                    <AppModuleGlobalSelectSearch
                      ...
                      } ${search.itemCode ? 'bg-yellow-50 text-black' : ''}`"
                  ...
                  <div class="join">
                    ...
                    <input
                      ...
                      :class="search.pdNo ? 'bg-yellow-50 text-black' : ''"
                      v-model="search.pdNo"
                    />
                  </div>
                  <div class="join">
                ...
                <div class="grid gap-3 lg:grid-cols-2 grid-cols-1 mt-2">
                  <div class="join">
                    <button
                      class="join-item btn btn-sm disabled:border-gray-300 disabled:bg-transparent disabled:text-base-content"
                      disabled
                    ...
                    <input
                      ...
                      class="join-item input input-sm input-bordered w-full border-gray-300"
                      :class="search.docDate.from ? 'bg-yellow-50 text-black' : ''"
                    ...
                    <input
                      ...
                      placeholder="to date"
                      class="join-item input input-sm input-bordered w-full border-gray-300"
                      :class="search.docDate.to ? 'bg-yellow-50 text-black' : ''"
