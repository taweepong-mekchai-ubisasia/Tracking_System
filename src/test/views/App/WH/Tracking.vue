<template>
      ...
      <template #view>
        <div class="flex flex-col gap-4">
          <div class=" flex flex-col-reverse lg:flex-row flex-nowrap justify-around items-center gap-4">
            ...
            <div    v-if="seelct" class="max-h-[40vh] h-[40vh] self-center">
              <qrcode-stream
            ...
            <div v-else>กรุณาเลือกรายการ</div>
  ...
  <select class="select select-bordered select-sm w-full lg:max-w-xs join-item"   v-model="seelct">
  ...
  <div class="indicator">
    ...
    <button class="btn btn-primary btn-sm join-item">ยืนยัน</button>
  </div>
</div>
